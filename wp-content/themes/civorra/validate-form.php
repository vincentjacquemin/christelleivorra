...
$website = 'http://www.christelleivorra.com';
...
<html lang="fr-FR">
    <head>
        ...
        <script type="text/javascript">
            window._wpemojiSettings = {"baseUrl":"https:\/\/s.w.org\/images\/core\/emoji\/2.3\/72x72\/","ext":".png","svgUrl":"https:\/\/s.w.org\/images\/core\/emoji\/2.3\/svg\/","svgExt":".svg","source":{"concatemoji":"http:\/\/www.christelleivorra.com\/wp-includes\/js\/wp-emoji-release.min.js?ver=4.8"}};
        ...
        <link rel="alternate" type="application/json+oembed" href="<?php echo $website ?>/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fwww.christelleivorra.com%2F" />
        <link rel="alternate" type="text/xml+oembed" href="<?php echo $website ?>/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fwww.christelleivorra.com%2F&#038;format=xml" />
